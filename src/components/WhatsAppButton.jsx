...
function WhatsAppButton() {
  ...
  // Clean WhatsApp number - remove any spaces, dashes, or plus signs
  ...
  const whatsappUrl = `https://wa.me/${cleanNumber}?text=${encodeURIComponent('Hello! I have a question about your photo album service.')}`;

  const handleClick = (e) => {
    // Ensure number is valid before opening
